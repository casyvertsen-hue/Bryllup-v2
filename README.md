...
<section>
  ...
  <div class="box">
    ...
    <strong>Bidrag:</strong> Vi ønsker oss ikke gaver, men heller et bidrag til dagen økonomisk eller praktisk. <br><br>
  ...
  <div class="box">
    ...
    <img class="vin-bilde" src="Vin" alt="Bryllupsbilde">
  </div>
