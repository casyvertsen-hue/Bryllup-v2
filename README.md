...
<head>
  ...
  <style>
    ...
    header {background:url("https://drive.google.com/uc?export=view&id=1fG54F0l1mc9q-ux-rXeWerNG0PhLseRS") center/cover no-repeat; color:white; padding:80px 20px;}
...
<section>
  ...
  <div class="box">
    <h2>Vårt bilde 💛</h2>
    <img src="https://drive.google.com/uc?export=view&id=1-3Bq0lHkFbvZmCom0C6mwq9NusfhvmSQ" alt="Bryllupsbilde">
  </div>
