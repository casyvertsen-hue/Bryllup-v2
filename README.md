...
<head>
  ...
  <style>
    ...
    header {background:url(https://drive.google.com/file/d/1fG54F0l1mc9q-ux-rXeWerNG0PhLseRS/view?usp=drive_link) center/cover no-repeat; color:white; padding:80px 20px;}
